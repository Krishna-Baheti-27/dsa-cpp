...
int climbStairsTab(int n) {
    ...
    vector<int> dp(n + 1);
    dp[0] = 0, dp[1] = 1, dp[2] = 2; // no error here since n >= 3 so no problem in accessing dp[2]
